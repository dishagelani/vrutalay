...
const Expenses = () => {
  ...
  return (
    <>
      <Navbar />
      {expenses ? <div className='w-full h-full px-4'>
        ...
        {expenses.length > 0 ?
          ...
          <div className="relative h-50vh flex items-center justify-center">
            <div className="text-center">
              <p className="bg-gradient-to-r from-cyan-500 to-blue-500 text-gradient font-bold">Looks like your spending hasn’t started ! </p> <span>🤭</span></div>
          </div>
          ...
          <div className="flex justify-between">
            ...
            >
              {Array.from({ length: 11 - (moment().year() == 2024 ? 5 : 0) + 1 }, (_, i) =>
                moment().month((moment().year() == 2024 ? 5 : 0) + i).format('MMMM')
